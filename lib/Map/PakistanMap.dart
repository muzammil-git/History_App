          ...
          child: Container(
            ...
            child: Column(children: [
              Padding(
                ...
                child: Text(
                  'DRAG A CIRCLE ON A PAKISTANI REGION IN THE PICTURE BELOW AND DROP ON A SQUARE YOU THINK CONTAINS THE CORRECT NAME OF THE REGION.',
              ...
              Stack(children: [
                ...
                ), //positioned can only be use with stack.
                Positioned(
                  top: 200,
                  left: 25,
                  child: draggable1(),
...
//fata
                ...
                //kpk
                Positioned(top: 40, right: 150, child: draggable5()),
                //gb
                Positioned(top: 20, right: 90, child: draggable6()),
                //kashmir
                Positioned(top: 65, right: 80, child: draggable7()),
              ]),
              SizedBox(
                height: 20,
              ),
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      onPressed: () {
                        Navigator.of(context).pushNamedAndRemoveUntil(
                            'Continent', (Route<dynamic> route) => false);
                        print('Done');
                      },
                      style: ElevatedButton.styleFrom(
                          primary: Colors.blue,
...
class _dragtarget7State extends State<dragtarget7> {
  ...
  Widget build(BuildContext context) {
    ...
    {
      return DragTarget<double>(builder: (context, candidates, rejects) {
        return target7;
      }, onWillAccept: (data) {
        return true;
      }, onAcceptWithDetails: (data) {
