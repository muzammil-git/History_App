...
class _DragTarget1State extends State<DragTarget1> {
  ...
  Widget build(BuildContext context) {
    Widget first =Container(width: 50, height: 50,
...
class _DragTargetWidgetState extends State<DragTargetWidget2> {
  ...
  @override
  Widget build(BuildContext context) {
    Widget second =  Container(width: 50, height: 50,
...
class _DragTarget3State extends State<DragTarget3> {
  ...
  @override
  Widget build(BuildContext context) {
    Widget third = Container(width: 50, height: 50,
...
class _DragTarget5State extends State<DragTarget5> {
  ...
  Widget build(BuildContext context) {
    Widget fifth= Container(
      child: Align(alignment: Alignment.center, child: Text('Sindhi')),
      width: 50, height: 50,
      decoration: BoxDecoration(
          color: Colors.black,
          shape: BoxShape.circle,
