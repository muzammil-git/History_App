...
class _Draggable1State extends State<Draggable1> {
  ...
  Widget build(BuildContext context) {
    Widget first =Container(width: 150, height: 100,
      ...
      child:Image.asset('assets/images/new/Aligarh College.jpeg', ),
    );
    ...
    return accepted1==true? Container() : Draggable<String>(
      ...
      child: first,
      feedback:fb,
      childWhenDragging: Text('Aligarh College',style: TextStyle(
...
class _Draggable2State extends State<Draggable2> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget second =  Container(width: 150, height: 100,
        ...
        child: Image.asset('assets/images/new/Babur copy.jpeg',
          fit: BoxFit.contain,)
    );
...
class _Draggable3State extends State<Draggables3> {
  ...
  Widget build(BuildContext context) {
    Widget third = Container(width: 150, height: 100,
        ...
        child: Image.asset('assets/images/new/British Eduation.png')
    );
    ...
    return Draggable<num>(
      ...
      childWhenDragging: Text('British Education',style: TextStyle(
          fontWeight: FontWeight.bold, color: Colors.black,
          fontSize: 20)),
    );
  }
...
class _Draggable4State extends State<Draggable4> {
  ...
  Widget build(BuildContext context) { Widget fourth= Container(
      ...
      child: Image.asset('assets/images/new/two nations theoy copy.jpeg'));
  ...
  return Draggable<bool>(
    ...
    feedback:  Container(
        ...
        child: Image.asset('assets/images/new/two nations theoy copy.jpeg')),
    childWhenDragging:  Text('Two Nations Theory',style: TextStyle(
        fontWeight: FontWeight.bold, color: Colors.black,
        fontSize: 20)),
  );
  }
...
class _Draggable5State extends State<Draggable5> {
  ...
  Widget build(BuildContext context) {
    Widget fifth =  Container(width: 150, height: 100,
        ...
        child:Image.asset('assets/images/new/Indian National congress.jpeg')
    ...
    return  Draggable<int>(
      ...
      child: fifth,
      feedback: fifth,
      childWhenDragging:   Text('Indian National congress',style: TextStyle(
          fontWeight: FontWeight.bold, color: Colors.black,
          fontSize: 20)),);
  }
}
...
class _Draggable6State extends State<Draggable6> {
  ...
  Widget build(BuildContext context) {
    ...
    Image.asset('assets/images/new/Muslim League.png'),
      width:150 , height:100 ,
      decoration: BoxDecoration(
        border: Border.all(width: 1.5, color: Colors.black),
    ...
    return Draggable<double>(
      ...
      child: sixth,
      feedback: sixth,
      childWhenDragging:   Text('Muslim League',style: TextStyle(
          fontWeight: FontWeight.bold, color: Colors.black,
          fontSize: 20)),
    );
  }
...
class _Draggable7State extends State<Draggable7> {
  ...
  Widget build(BuildContext context) {
    Widget seven =Container(width: 150, height: 100,
      ...
      child:Image.asset('assets/images/new/Screenshot 2021-10-13 at 8.28.01 AM.png', ),
    ...
    return accepted7==true? Container() : Draggable<String>(
      ...
      child: seven,
      feedback:fb,
      childWhenDragging:  Text('British',style: TextStyle(
          fontWeight: FontWeight.bold, color: Colors.black,
          fontSize: 20)),
    );
  }
...
class _Draggable8State extends State<Draggable8> {
  ...
  Widget build(BuildContext context) {
    Widget eight =Container(width: 150, height: 100,
      ...
      child:Image.asset('assets/images/new/Sir syed.jpeg', ),
    );
    ...
    return accepted8==true? Container() : Draggable<String>(
      ...
      child: eight,
      feedback:fb,
      childWhenDragging:  Text('Sir syed',style: TextStyle(
          fontWeight: FontWeight.bold, color: Colors.black,
          fontSize: 20)),
    );
  }
...
class _Draggable9State extends State<Draggable9> {
  ...
  Widget build(BuildContext context) {
    Widget nineth =Container(width: 150, height: 100,
      ...
      child:Image.asset('assets/images/new/Pakistan Resolution.jpeg', ),
    );
    ...
    return accepted9==true? Container() : Draggable<num>(
      ...
      child: nineth,
      feedback:fb,
      childWhenDragging:  Text('Pakistan Resolution',style: TextStyle(
          fontWeight: FontWeight.bold, color: Colors.black,
          fontSize: 20)),
    );
  }
...
class _Draggable10State extends State<Draggable10> {
  ...
  Widget build(BuildContext context) {
    Widget tenth =Container(width: 150, height: 100,
      ...
      child:Image.asset('assets/images/new/war of independence.jpeg', ),
    );
//data is imp
    Widget fb = tenth;
    ...
    return accepted10==true? Container() : Draggable<Color>(
      ...
      child: tenth,
      feedback:fb,
      childWhenDragging:  Text('War of Independence',style: TextStyle(
          fontWeight: FontWeight.bold, color: Colors.black,
          fontSize: 20)),
    );
  }
